...
#define S(mg, eg) Score(mg, eg)
	std::vector<Score> knightMobility = { S(-62,-79), S(-53,-57), S(-12,-31), S(-3,-17), S(3,  7), S(12, 13), // Knight
	  S(21, 16), S(28, 21), S(37, 26) };
	std::vector<Score> bishopMobility = { S(-47,-59), S(-20,-25), S(14, -8), S(29, 12), S(39, 21), S(53, 40), // Bishop
	  S(53, 56), S(60, 58), S(62, 65), S(69, 72), S(78, 78), S(83, 87),
	  S(91, 88), S(96, 98) };

	std::vector<Score> rookMobility = { S(-60,-82), S(-24,-15), S(0, 17) ,S(3, 43), S(4, 72), S(14,100), // Rook
	  S(20,102), S(30,122), S(41,133), S(41 ,139), S(41,153), S(45,160),
	  S(57,165), S(58,170), S(67,175) };

	std::vector<Score> queenMobility = { S(-29,-49), S(-16,-29), S(-8, -8), S(-8, 17), S(18, 39), S(25, 54), // Queen
	  S(23, 59), S(37, 73), S(41, 76), S(54, 95), S(65, 95) ,S(68,101),
	  S(69,124), S(70,128), S(70,132), S(70,133) ,S(71,136), S(72,140),
	  S(74,147), S(76,149), S(90,153), S(104,169), S(105,171), S(106,171),
	  S(112,178), S(114,185), S(114,187), S(119,221) };

	std::vector<std::vector<Score>> mobilityBonus = {
		knightMobility,
		bishopMobility,
		rookMobility,
		queenMobility
