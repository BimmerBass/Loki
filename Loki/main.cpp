...
int main(int argc, char* argv[]) {
	...
	DataGeneration::Analysis::Analyzer an("C:\\Users\\abild\\Desktop\\quiet-labeled.epd", "C:\\Users\\abild\\Desktop\\first_test.lgd", 2, 4, DataGeneration::DEFAULT_EVAL_LIMIT, 100000);
	an.run_analysis();
