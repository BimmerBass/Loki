...
int main(int argc, char* argv[]) {
	...
	//Training::Trainer tr("C:\\Users\\abild\\Desktop\\quiet.csv", 1000, 14500, Training::LOSS_F::AAE, 4, 0.05, 0.01);
	Training::Trainer tr("C:\\Users\\abild\\Desktop\\quiet_test.csv", 1000, 1, Training::LOSS_F::AAE, 4, 0.05, 0.01);
	tr.train_model();
